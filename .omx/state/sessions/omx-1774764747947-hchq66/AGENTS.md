...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1774764747947-hchq66 | 2026-03-29T06:12:27.968Z

**Codebase Map:**
  src/app/: page, page, page, page, page, page, page, page, layout, page
  src/components/: api-key-detail, api-keys-list, combobox-filter, copy-to-clipboard, data-table, date-range-picker, dropdown-filter, email-detail, emails-header, emails-sending-data-table
  src/lib/: api-auth, cloudflare, schema, s3, ses
  tests/: api-emails.test, api-key-detail.test, api-keys-modal.test, api-keys-page.test, cloudflare.test, data-table.test, api-key-detail.spec, email-detail.spec, emails-data-table.spec, emails-filter-bar.spec
  (root): drizzle.config, next-env.d, next.config, playwright.config, postcss.config, tailwind.config, vitest.config
